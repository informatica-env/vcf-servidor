...
ráfagas de carga, y bajar la frecuencia de escaneo de Imunify360 sobre
`wp-content/uploads` (356k ficheros).

---

## 6. Qué comprobar después de una migración o una restauración
